            ...
            message.channel.awaitMessages(m => m.author.id == message.author.id,
                {max: 1, time: 180000}).then(collected => {
                    // only accept messages by the user who sent the command
                      ...
                      var parentnum = collected.first().content;
                      if (isNaN(parentnum) == false) {
                                                    ...
                                                    {max: 1, time: 180000}).then(collected => {
                                                        // only accept messages by the user who sent the command
                                                          ...
                                                          if (isNaN(mutationchance) == false) {
                                                              ...
                                                              /*message.channel.send('Please enter your estimates as *how many parents have the specified born type*.');
                                                              message.channel.send('If a rainbow voucher is being used, the rainbow born type chance should equal the number of parent blobs.');
                                                              message.channel.send('It should be in the format specified below:');
                                                              message.channel.send('Water, Rainbow, Snek, Plant, Battle');*/
                                                                                    ...
                                                                                    if ((isNaN(parseInt(borntypearray[2])) == false) && (parseInt(borntypearray[2]) <= parentnum)) {
                                                                                        ...
                                                                                        if ((isNaN(parseInt(borntypearray[3])) == false) && (parseInt(borntypearray[3]) <= parentnum)) {
                                                                                            ...
                                                                                            if ((isNaN(parseInt(borntypearray[4])) == false) && (parseInt(borntypearray[4]) <= parentnum)) {
                                                                                                ...
                                                                                                /*message.channel.send('***VOUCHERLISTS***');
                                                                                                message.channel.send('Make sure to name your vouchers similarly from blobling to blobling.');
                                                                                                message.channel.send('Spaces and capitalizations matter.');
                                                                                                message.channel.send('shapechange != shape change != Shape Change');
                                                                                                message.channel.send('Example list: head 1, teeth 1, shapechange 1, eye 1, wing 2, frill 2, ear 1, other 2, tail 2, leg 12, marking 8');*/
                                                                                                            ...
                                                                                                            if (parentnum == 1){
                                                                                                              ...
                                                                                                              message.channel.awaitMessages(m => m.author.id == message.author.id,
                                                                                                                  ...
                                                                                                                  message.channel.send('**New mutations: ' + muttemp +'**');
                                                                                                                  ...
                                                                                                                  message.reply('...wait, did u say 1 parent. haha pls');
                                                                                                                  });
                                                                                                                  }
                                                                                                                                    ...
                                                                                                                                    //END BABY CODE
                                                                                                                                      ...
                                                                                                                                      if (parentnum == 5){
                                                                                                                                        ...
                                                                                                                                        message.channel.awaitMessages(m => m.author.id == message.author.id,
                                                                                                                                            ...
                                                                                                                                            var voucherlist4 = ["head 1", "mouth 1", "shapechange 3", "leg 8"];
                                                                                                                                            var voucherlist4strings = [];
                                                                                                                                            var voucherlist4vals = [];
